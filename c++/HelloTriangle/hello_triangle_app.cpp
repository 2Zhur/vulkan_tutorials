...
bool hello_triangle_application::check_device_extension_support(VkPhysicalDevice device) {
...
swap_chain_support_details hello_triangle_application::query_swap_chain_support(VkPhysicalDevice device) {
